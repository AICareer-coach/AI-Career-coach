document.addEventListener("DOMContentLoaded", () => {
    ...
    const fetchLeaderboard = async (user) => {
        try {
            ...
            const response = await fetch("https://ai-career-coach-backend-amp9.onrender.com/api/leaderboard/", {
                headers: {
    ...
    compareBtn.addEventListener("click", async () => {
        ...
        try {
            ...
            const response = await fetch("https://ai-career-coach-backend-amp9.onrender.com/api/leaderboard/compare", {
                method: "POST",
                headers: {
