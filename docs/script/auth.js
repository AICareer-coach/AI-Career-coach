...
auth.onAuthStateChanged(user => {
    if (user) {
        ...
        const protectedPaths = ['/AI-Career-coach/home.html', '/AI-Career-coach/profile.html', '/AI-Career-coach/optimizer.html', '/AI-Career-coach/roadmap.html', '/AI-Career-coach/joblisting.html','/AI-Career-coach/assessment.html','/AI-Career-coach/interview.html','/AI_Career-coach/portfolio_generator.html'];
